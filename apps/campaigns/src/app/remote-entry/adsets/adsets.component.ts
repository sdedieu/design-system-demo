...
import { CdsTableModule, CdsButtonModule, CdsIconModule, CdsCardModule, CdsPaginatorModule } from '@cds-library';
...
@Component({
  ...
  template: `
    <div class="cds-flex cds-justify-end cds-gap-1 cds-mb-4">
      <button disabled extended mat-fab><mat-icon>add</mat-icon> Add Adset</button>
    </div>
