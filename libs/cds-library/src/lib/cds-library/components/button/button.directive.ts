...
import {
    CdsSemanticVariations,
    CdsSize,
    CdsType,
} from '../../theming/theming.model';

export type CdsButtonColor = Extract<
    CdsSemanticVariations,
...
export const CDS_BUTTON_DEFAULT_OPTIONS = new InjectionToken<
    CdsButtonDefaultOptions
>('CDS_BUTTON_DEFAULT_OPTIONS');
...
export const CdsButtonDirectiveImports = [CdsButtonDirective, MatButtonModule];
