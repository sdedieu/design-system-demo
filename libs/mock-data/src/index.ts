...
export const ADSET_DATA = [
  ...
  },
  {
    ...
    campaignName: 'Holiday Sale 2026',
    ...
    series: [
      {
        ...
        data: [
          [13082, 70.303, 9212824, 'Australia 🇦🇺', 2026],
          [13513, 70.015, 15733858, 'Canada 🇨🇦', 2026],
          [8757, 62.7523, 6539470, 'Cuba 🇨🇺', 2026],
          [8802, 67.258, 4235423, 'Finland 🇫🇮', 2026],
          [9453, 68.708, 43528065, 'France 🇫🇷', 2026],
          [10998, 68.4080901, 71313740, 'Germany 🇩🇪', 2026],
          [10548, 73.293, 157584, 'Iceland 🇮🇸', 2026],
          [963, 37.6538, 409280196, 'India 🇮🇳', 2026],
          [3464, 65.861, 88389994, 'Japan 🇯🇵', 2026],
          [1139, 49.9673, 21168611, 'South Korea 🇰🇷', 2026],
          [14883, 70.599, 2136000, 'New Zealand 🇳🇿', 2026],
          [13438, 73.314, 3429431, 'Norway 🇳🇴', 2026],
          [5386, 63.939, 27269745, 'Poland 🇵🇱', 2026],
          [4156, 44.9343, 24253200, 'Turkey 🇹🇲', 2026],
          [12531, 70.07, 51113711, 'United Kingdom 🇬🇧', 2026],
          [17409, 69.476, 170796378, 'United States 🇺🇸', 2026],
        ],
      },
    ],
    animationDuration: 0,
